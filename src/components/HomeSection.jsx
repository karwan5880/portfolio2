...
export const HomeSection = () => {
  ...
  // Handle navigation within multiverse context
  const handleTimelineNavigation = (e) => {
    armAudio()
    // In multiverse context, scroll to timeline section instead of navigating
    if (e) {
      e.preventDefault()
    }
      ...
      <div ref={resumeContainer}>
        <div className={styles.pageWrapper}>
          <div className={styles.documentContainer}>
            ...
            <DogEar href="#timeline" position="bottom-right" aria-label="View the timeline" onNavigateStart={handleTimelineNavigation} />
          </div>
        </div>
      </div>
    </div>

  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="text-center z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div
          className="font-mono text-cyan-400 text-left mb-8 bg-black/80 border border-cyan-500/30 rounded-lg p-6 backdrop-blur-sm"
        ...
        <motion.div
          className="text-2xl md:text-3xl font-mono text-cyan-400 mb-12"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* CTA Button */}
        <motion.button
          className="cursor-cta group relative px-12 py-6 bg-transparent border-2 border-cyan-400 text-cyan-400 font-mono font-bold rounded-lg overflow-hidden"
          initial={{ opacity: 0, y: 50 }}
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-8">
                ...
                {/* Access Button */}
                <motion.div
                  className="flex items-center text-cyan-400 font-mono text-sm group-hover:translate-x-2 transition-transform"
                  whileHover={{ x: 5 }}
                >

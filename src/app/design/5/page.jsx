...
const MorphingGlassNav = () => {
  ...
  return (
    <motion.nav
      className="liquid-interactive fixed top-8 left-1/2 transform -translate-x-1/2 z-40"
    ...
    >
      ...
      >
        {navItems.map((item) => (
          <motion.button
            key={item.id}
            className={`liquid-interactive relative px-4 py-2 text-sm font-medium transition-colors ${activeItem === item.id ? 'text-black' : 'text-white hover:text-gray-300'}`}
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden">
      ...
      <motion.div
        ...
        animate={{
          background: [
            `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(139, 92, 246, 0.3) 0%, transparent 50%)`,
            `radial-gradient(circle at ${mousePos.x + 20}% ${mousePos.y + 20}%, rgba(59, 130, 246, 0.3) 0%, transparent 50%)`,
            `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(139, 92, 246, 0.3) 0%, transparent 50%)`,
          ],
        }}
      ...
      <motion.div
        ...
        animate={{
          background: [
            `radial-gradient(ellipse at ${100 - mousePos.x}% ${100 - mousePos.y}%, rgba(16, 185, 129, 0.2) 0%, transparent 60%)`,
            `radial-gradient(ellipse at ${80 - mousePos.x}% ${80 - mousePos.y}%, rgba(6, 182, 212, 0.2) 0%, transparent 60%)`,
            `radial-gradient(ellipse at ${100 - mousePos.x}% ${100 - mousePos.y}%, rgba(16, 185, 129, 0.2) 0%, transparent 60%)`,
          ],
        }}
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  background: [
                    project.gradient,
                    project.gradient.replace('135deg', '225deg'),
                    project.gradient.replace('135deg', '315deg'),
                    project.gradient,
                  ],
                }}
              ...
              <motion.div
                ...
                animate={{
                  background: [
                    `radial-gradient(ellipse at 30% 70%, ${project.color}, transparent)`,
                    `radial-gradient(ellipse at 70% 30%, ${project.color}, transparent)`,
                    `radial-gradient(ellipse at 30% 70%, ${project.color}, transparent)`,
                  ],
                }}

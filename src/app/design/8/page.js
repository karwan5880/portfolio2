...
const LandingSection = () => {
  ...
  const dividerVariants = {
    ...
    visible: {
      ...
      transition: { duration: 1.0, ease: 'easeOut', delay: 1.5 }, // Delay until after text draws
    },
  }
  ...
  return (
    ...
    >
      ...
      <motion.div {...scrollIndicatorAnimation} className="absolute bottom-8 left-1/2 transform -translate-x-1/2"></motion.div>
    </section>
  )
}

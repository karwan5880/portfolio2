...
const SimulationMaterial = shaderMaterial({ uPositionTexture: null, uTargetPositionTexture: null, uDroneInfoTexture: null, uStartPosTexture: null, uTime: 0, uRepulsionRadius: 0.5, uRepulsionStrength: 0.2 }, simShader.vertexShader, simShader.fragmentShader)
...
export function DroneShowSimulation() {
  ...
  useFrame((state) => {
    ...
    simMaterial.uniforms.uStartPosTexture.value = data.startPosTexture // Pass the new texture

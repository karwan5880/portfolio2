...
// --- NEW: Import post-processing components ---
...
function BoidsSimulation() {
  ...
  // The rest of the BoidsSimulation component is UNCHANGED...
...
// --- START OF CHANGES: Add EffectComposer and Bloom ---
      ...
      <Canvas camera={{ position: [0, 0, 12], fov: 75 }}>
        ...
        <EffectComposer>
          <Bloom
            ...
            mipmapBlur={true} // Creates a more natural, feathered glow
          />
        </EffectComposer>
      </Canvas>
    </React.Suspense>

export const InstancedParticleShader = {
  vertexShader: /*glsl*/ `
    // We get the instanceMatrix automatically from Three.js
    // It contains the position/rotation/scale for each instance.

    void main() {
      // We transform the vertex position by the instance's matrix first,
      // and then by the standard camera matrices.
  ...
  `,
  fragmentShader: /*glsl*/ `
    // For now, a simple fragment shader.
    // We will add the glow and pulse back in here later.
    void main() {
      gl_FragColor = vec4(0.0, 1.0, 0.4, 1.0); // Electric Green
    }
  `,
}

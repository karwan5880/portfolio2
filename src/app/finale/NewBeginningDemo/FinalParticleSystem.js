...
export function FinalParticleSystem({ scale = 1.0, pulseFrequency = 5.0 }) {
  ...
  const { lightGeometry, bodyGeometry, textPositionsTexture } = useMemo(() => {
    ...
    // const textGeo = new TextGeometry('藝恬 T H A N K  Y O U', { font: font, size: 300.0, height: 50.0, curveSegments: 12, bevelEnabled: true, bevelThickness: 10.0, bevelSize: 4.0, bevelSegments: 5 })

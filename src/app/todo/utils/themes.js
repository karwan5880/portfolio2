...
export const THEME_CONFIG = {
  [THEMES.DARK]: {
    ...
    classes: {
      ...
      input: 'bg-gray-700 border-gray-600 text-gray-300 placeholder:text-gray-500 focus:bg-gray-800',
  ...
  [THEMES.LIGHT]: {
    ...
    classes: {
      ...
      input: 'bg-gray-50 border-gray-200 text-gray-700 placeholder:text-gray-400 focus:bg-white',
  ...
  [THEMES.BLUE]: {
    ...
    classes: {
      ...
      input: 'bg-blue-700 border-blue-600 text-blue-100 placeholder:text-blue-300 focus:bg-blue-600',
  ...
  [THEMES.GREEN]: {
    ...
    classes: {
      ...
      input: 'bg-green-700 border-green-600 text-green-100 placeholder:text-green-300 focus:bg-green-600',
  ...
  [THEMES.PURPLE]: {
    ...
    classes: {
      ...
      input: 'bg-purple-700 border-purple-600 text-purple-100 placeholder:text-purple-300 focus:bg-purple-600',
